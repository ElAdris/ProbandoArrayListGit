...
/**
 * Clase que contiene las estancias para la base de datos. Todas las instancias
 * están hechas en Instanciador
 *
 * @author Adrián José
...
public class Instanciador extends BaseDeDatos2 {
    ...
    /**
     * Para poder asignar la instancia a la base de datos hay que llamar al
     * método agregarPersonas, de la clase BaseDeDatos2
     *
